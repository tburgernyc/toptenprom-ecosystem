...
export default async function PromRegistryPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div className="bento-card space-y-4">
          <div className="flex items-start gap-3">
            <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-[var(--radius-md)] bg-[var(--color-primary-subtle)]">
              <svg
                aria-hidden="true"
        ...
        <div className="bento-card space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full bg-[var(--color-bg-glass)] px-2.5 py-0.5 text-xs font-semibold text-[var(--color-text-muted)]">
              0 total
            </span>
          </div>
      ...
      {/* Extraction guide */}
      <div className="bento-card bg-[var(--color-primary-subtle)]">
        <h2 className="mb-3 text-sm font-semibold text-[var(--color-text)]">
          AI Extraction Guide
        </h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 text-xs text-[var(--color-text-muted)]">
          <div>
...
function RegistryList() {
  return (
    <div className="flex min-h-[200px] flex-col items-center justify-center rounded-[var(--radius-lg)] border border-dashed border-[var(--color-border)] py-8 text-center">
      <svg
        aria-hidden="true"
        className="mx-auto mb-3 h-8 w-8 text-[var(--color-text-subtle)]"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={1.5}
