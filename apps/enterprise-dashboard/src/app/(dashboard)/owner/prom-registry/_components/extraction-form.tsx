    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <textarea
          ...
          className="w-full resize-y rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-sm text-[var(--color-foreground)] placeholder:text-[var(--color-foreground-subtle)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
        />
      </div>
...
const inputClass =
  "w-full rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-sm text-[var(--color-foreground)] placeholder:text-[var(--color-foreground-subtle)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)] disabled:cursor-not-allowed disabled:opacity-60";
...
function SaveToRegistryForm({
  ...
  return (
    <form onSubmit={handleSaveSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="reg-customerName" className="mb-1.5 block text-xs font-medium text-[var(--color-foreground)]">
      ...
      <div>
        <label htmlFor="reg-customerEmail" className="mb-1.5 block text-xs font-medium text-[var(--color-foreground)]">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label htmlFor="reg-customerPhone" className="mb-1.5 block text-xs font-medium text-[var(--color-foreground)]">
            Phone
          </label>
          <input
        ...
        <div>
          <label htmlFor="reg-eventDate" className="mb-1.5 block text-xs font-medium text-[var(--color-foreground)]">
            Event Date
          </label>
          <input
            id="reg-eventDate"
  ...
  if (savedId) {
    return (
      <div className="space-y-4 text-center">
        ...
        <div>
          <p className="text-sm font-semibold text-[var(--color-foreground)]">Saved to Registry</p>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <span
          ...
          style={{
            color: confidenceColor[data.confidence] ?? "var(--color-foreground)",
            backgroundColor: `color-mix(in oklch, ${confidenceColor[data.confidence] ?? "var(--color-foreground)"} 15%, transparent)`,
          }}
        >
          <span
            ...
            style={{
              backgroundColor:
                confidenceColor[data.confidence] ?? "var(--color-foreground)",
            }}
          />
