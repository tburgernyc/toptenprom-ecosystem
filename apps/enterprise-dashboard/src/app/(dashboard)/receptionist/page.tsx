      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="bento-card lg:col-span-2">
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="rounded-full bg-[var(--color-brand-primary-subtle)] px-2.5 py-0.5 text-xs font-semibold text-[var(--color-brand-primary)]">
              0 today
            </span>
          </div>
          <AppointmentQueue />
    ...
    <div className="space-y-2">
      <div className="flex items-center justify-center rounded-[var(--radius-lg)] border border-dashed border-[var(--color-border)] py-12 text-center">
        <div>
          <svg
            aria-hidden="true"
            className="mx-auto mb-2 h-8 w-8 text-[var(--color-foreground-subtle)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={1.5}
  ...
  return (
    <div className="space-y-3">
      ...
      <a
        ...
        className="flex w-full items-center justify-center gap-2 rounded-[var(--radius-md)] bg-[var(--color-brand-primary)] px-4 py-2 text-sm font-medium text-[var(--color-foreground-on-brand)] transition-colors hover:bg-[var(--color-brand-primary-hover)]"
      >
        <svg
          aria-hidden="true"
          className="h-4 w-4"
  ...
  return (
    <div className="space-y-2 text-sm">
      {[
        ...
        { label: "Checked out", count: 0, color: "var(--color-foreground-muted)" },
      ].map((item) => (
