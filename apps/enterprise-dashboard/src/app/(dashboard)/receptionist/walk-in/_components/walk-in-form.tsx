      ...
      <div className="space-y-4 text-center">
        ...
        <div className="flex justify-center gap-3 pt-2">
          <button
            type="button"
            onClick={handleReset}
            className="inline-flex h-9 items-center justify-center rounded-[var(--radius-md)] bg-[var(--color-brand-primary)] px-5 text-sm font-medium text-[var(--color-foreground-on-brand)] transition-colors hover:bg-[var(--color-brand-primary-hover)]"
          >
            Log Another Walk-in
          </button>
          <a
            href="/receptionist"
            className="inline-flex h-9 items-center justify-center rounded-[var(--radius-md)] border border-[var(--color-border-strong)] bg-[var(--color-surface)] px-5 text-sm font-medium text-[var(--color-foreground)] transition-colors hover:bg-[var(--color-surface-overlay)]"
          >
            Back to Front Desk
          </a>
        </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <div className="flex items-center gap-3">
        <button
          type="submit"
          disabled={isSubmitting}
          className="inline-flex h-9 items-center justify-center rounded-[var(--radius-md)] bg-[var(--color-brand-primary)] px-5 text-sm font-medium text-[var(--color-foreground-on-brand)] transition-colors hover:bg-[var(--color-brand-primary-hover)] disabled:cursor-not-allowed disabled:opacity-60"
        >
          {isSubmitting ? (
            <>
              <span
        ...
        <a
          href="/receptionist"
          className="text-sm text-[var(--color-foreground-muted)] underline underline-offset-2 hover:no-underline"
        >
          Cancel
        </a>
      </div>
